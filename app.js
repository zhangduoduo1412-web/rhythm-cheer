...
const scoreCharacter = createAlphaPlayer(document.querySelector("#score-character"), characterVideos.normal1);
...
const resultCharacter = createAlphaPlayer(document.querySelector("#result-character"), characterVideos.curtain);
